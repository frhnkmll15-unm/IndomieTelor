...
public class Crypto {
	...
	private static String defaultKey = "c6c65100d224d9fe9ec35fdfc7a1fb4f";
    ...
    public static void main(String[] args) {
        ...
        String strToEncrypt = "5854589a";//put text to encrypt in here
        String encryptionResult = new Crypto().performEncrypt(strToEncrypt);
        System.out.println("Encryption Result : "+encryptionResult);

        String strToDecrypt = "13b3737168219dcce174beda9dc85aed";//put text to decrypt in here
